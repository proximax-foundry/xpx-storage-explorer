<template>
  ...
  <template v-else>
    <ErrorState v-if="driveDetails.err" :err="driveDetails.err" />
    <template v-else>
      ...
      >
        <div class="hero-body">
          ...
          <div class="columns">
            ...
            <div
              v-if="driveDetails.replicators.length > 0"
              class="column col-12"
            >
      ...
      <div
        v-if="
          driveDetails.Files.length == 0 && driveDetails.Folders.length == 0
        "
        class="empty"
      >
