<template>
  ...
  <template v-else>
    ...
    <template v-else>
      ...
      >
        ...
        <div class="tile-content hide-lg">
          ...
          <div class="tile=subtitle">
            Duration:
            <b>
              {{ $filters.numberArrayToCompact(item.drive.duration) }} Block(s)
            </b>
          </div>
        </div>
        ...
        <div class="tile-content hide-lg">
          <div class="tile-title">
            Billing Price:
            <b>
              {{ $filters.numberArrayToCompact(item.drive.billingPrice) }} SO
            </b>
          </div>
          <div class="tile=subtitle">
            Billing Period:
      ...
      <ul class="pagination">
        <template v-if="drives.pagination.totalPages < 11">
          <li
            class="page-item"
            :class="{ disabled: drives.pagination.pageNumber == 1 }"
          >
            <router-link
              :to="{
                path: '/drives',
                query: {
                  pageNumber:
                    drives.pagination.pageNumber == 1
                      ? 1
                      : drives.pagination.pageNumber - 1,
                },
              }"
          ...
          <li
            v-for="n in drives.pagination.totalPages"
            :key="n"
            class="page-item"
            :class="{ active: n == drives.pagination.pageNumber }"
          >
            <router-link
          ...
          <li
            ...
            :class="{
              disabled:
                drives.pagination.pageNumber == drives.pagination.totalPages,
            }"
          >
            <router-link
              :to="{
        ...
        <template v-else-if="drives.pagination.pageNumber == 1">
          ...
          <li class="page-item">
            <router-link
              :to="{
                path: '/drives',
                query: { pageNumber: drives.pagination.totalPages },
              }"
              class="btn btn-link"
              >{{ drives.pagination.totalPages }}</router-link
            >
          </li>
          <li class="page-item">
            <router-link
        ...
        >
          <li class="page-item">
            <router-link
              :to="{
                path: '/drives',
                query: { pageNumber: drives.pagination.pageNumber - 1 },
              }"
              class="btn btn-link"
              >Prev</router-link
            >
          ...
          <li class="page-item">
            <router-link
              :to="{
                path: '/drives',
                query: { pageNumber: drives.pagination.pageNumber - 2 },
              }"
              class="btn btn-link"
              >{{ drives.pagination.pageNumber - 2 }}</router-link
            >
          </li>
          <li class="page-item">
            <router-link
              ...
              class="btn btn-link"
              >{{ drives.pagination.pageNumber - 1 }}</router-link
            >
          </li>
          <li class="page-item active">
            <router-link
        ...
        <template v-else>
          ...
          <li v-if="drives.pagination.pageNumber - 1 != 1" class="page-item">
            <router-link
              :to="{ path: '/drives', query: { pageNumber: 1 } }"
              class="btn btn-link"
              >1</router-link
          ...
          <li v-if="drives.pagination.pageNumber > 3" class="page-item">
            <span>...</span>
          </li>
          <li class="page-item">
            <router-link
          ...
          <li class="page-item active">
            <router-link
              :to="{
                path: '/drives',
                query: { pageNumber: drives.pagination.pageNumber },
              }"
              class="btn btn-link"
            >
              {{ drives.pagination.pageNumber }}
            </router-link>
          </li>
          <li class="page-item">
            <router-link
          ...
          <li
            v-if="
              drives.pagination.pageNumber < drives.pagination.totalPages - 2
            "
            class="page-item"
          >
            <span>...</span>
          ...
          <li
            v-if="
              drives.pagination.pageNumber + 1 != drives.pagination.totalPages
            "
            class="page-item"
          >
            <router-link
